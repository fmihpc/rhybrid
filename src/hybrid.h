...
struct Hybrid {
   ...
   static Real laminarR2,laminarR3,coeffDip,coeffQuad,dipSurfB,dipSurfR,dipMinR2,dipMomCoeff,xDip,yDip,zDip,xDipMirror,yDipMirror,zDipMirror,thetaDip,phiDip;
